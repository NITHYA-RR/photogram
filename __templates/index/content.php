  ...
  <div class="row py-lg-5">
    <form id="post-form" enctype="multipart/form-data">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <textarea id="post_text" name="post_text" class="form-control" placeholder="What are you upto?" rows="3" required></textarea>
        <div class="input-group mb-3">
          <input type="file" accept="image/*" class="form-control" name="post_image" id="inputGroupFile02" required>
        </div>
        <p>
          <button class="btn btn-success my-2" type="submit" id="share-btn">Share memory</button>
